...
class Artikel_admin extends CI_Controller
{
    ...
    {
        $data['artikel'] = $this->m_user->tampil_data_artikel()->result(); // m_bilal : nama model bilal, tampil_data = u/mengambil data
    ...
    public function edit($ID_ARTIKEL)
    {
        ...
        $data['artikel'] = $this->m_user->edit_data($where, 'artikel')->result(); //m_bilal = nama modalnya, masukkan nma function edit_data
